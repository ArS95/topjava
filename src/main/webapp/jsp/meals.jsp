...
<body>
<section>
    <table class="table table-striped table-hover table-sm" border="1" cellpadding="8" cellspacing="0">
    ...
    <button type="button" class="btn btn-outline-primary"><a href="?action=add">Добавить еду</a></button>
</section>
